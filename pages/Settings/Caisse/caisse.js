  ...
  render() {
    ...
    return (
      <View>
        ...
        <Categorie products={products} isVisible={this.state.categoryVisibility} handleClose={this.handleClose}/>
      </View>
    );
  }
}
...
const Categorie = ({isVisible, products, handleClose}) => {
  const category = Object.keys(products);
  return (
    <DefaultHeader isVisible={isVisible} handleClose={handleClose} title="Categorie">
...
export default withNavigation(connect(mapStateToProps)(CaisseSettings));
